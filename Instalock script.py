...
# Définition des coordonnées des agents
agent_coordinates = {
    "Astra": (639, 848),
    "Breach": (710, 832),
    "Brimstone": (790, 840),
...
# Création de labels et de boutons pour l'interface
text_output = tk.Label(window, text="", fg='black', font=("Helvetica", 12))
text_output.grid(row=3, column=0, columnspan=5, pady=10)

agents = ["Astra", "Breach", "Brimstone", "Chamber", "Cypher", "Deadlock", "Fade", "Gekko",
